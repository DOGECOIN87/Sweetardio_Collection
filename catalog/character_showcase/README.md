...
One render of each of the 27 characters against the background chosen to suit that particular body. Every character gets a DIFFERENT plate — the set is solved as an assignment so no plate repeats, which is most of what makes it read as curated rather than sampled.

Selection was scored then corrected by eye. The score maximises hue complement and luminance separation between body and plate. A first attempt that also rewarded a calm, desaturated plate was thrown away: it handed 24 of the 27 the same four near-greyscale plates, because it was measuring "empty background", not appeal.
...
|---|---|---|
| Nutty_Bar | Tootsie_Blue.png | eye |
